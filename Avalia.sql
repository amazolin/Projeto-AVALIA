...
('Qual tipo de dado armazena texto longo?', 1, 1, 'c'),
('Qual comando insere dados em uma tabela?', 1, 1, 'b'),
('Qual comando remove uma tabela?', 1, 1, 'b'),
('Qual comando modifica dados já existentes?', 1, 1, 'a'),
('Qual comando mostra todas as tabelas de um banco?', 1, 1, 'a'),
('Qual cláusula é usada para ordenar resultados?', 1, 1, 'b'),
('Qual comando adiciona uma nova coluna em uma tabela?', 1, 1, 'a'),
('Qual cláusula filtra registros?', 1, 1, 'a');
...
('Qual operador é usado para incremento?', 2, 1, 'b'),
('Qual é o cabeçalho da função principal?', 2, 1, 'c'),
('Qual palavra-chave declara uma constante?', 2, 1, 'b'),
('Qual estrutura de repetição verifica primeiro a condição?', 2, 1, 'a'),
('Qual operador lógico representa E?', 2, 1, 'c'),
('Qual biblioteca é usada para entrada e saída padrão?', 2, 1, 'a'),
('Qual tipo de dado armazena caracteres?', 2, 1, 'c'),
('Qual símbolo indica ponteiro?', 2, 1, 'b');
...
-- Linguagem de Programação C# (Disciplina ID 3)
INSERT INTO questoes (texto_questao, id_disciplina, id_criador, alternativa_correta) VALUES
('Qual é a extensão padrão de arquivos C#?', 3, 1, 'b'),
('Qual namespace contém classes básicas do C#?', 3, 1, 'a'),
('Qual comando imprime no console?', 3, 1, 'c'),
('Qual palavra-chave define uma classe?', 3, 1, 'c'),
('Qual tipo representa números inteiros?', 3, 1, 'a'),
('Qual palavra-chave cria um objeto?', 3, 1, 'b'),
('Qual palavra-chave indica herança?', 3, 1, 'c'),
('Qual método é o ponto de entrada do programa?', 3, 1, 'c'),
('Qual estrutura de decisão existe em C#?', 3, 1, 'a'),
('Qual tipo de dado armazena verdadeiro ou falso?', 3, 1, 'c');
...
-- Estrutura de Dados em Java (Disciplina ID 4)
INSERT INTO questoes (texto_questao, id_disciplina, id_criador, alternativa_correta) VALUES
('Qual estrutura segue o princípio FIFO?', 4, 1, 'b'),
('Qual estrutura segue o princípio LIFO?', 4, 1, 'a'),
('Qual classe implementa listas dinâmicas em Java?', 4, 1, 'b'),
('Qual estrutura é usada para busca rápida por chave?', 4, 1, 'c'),
('Qual algoritmo ordena dividindo em subproblemas?', 4, 1, 'b'),
('Qual é a complexidade do acesso em ArrayList?', 4, 1, 'a'),
('Qual árvore é balanceada automaticamente?', 4, 1, 'a'),
('Qual estrutura usa prioridade?', 4, 1, 'c'),
('Qual método insere no final do ArrayList?', 4, 1, 'b'),
('Qual estrutura não permite elementos duplicados?', 4, 1, 'b');
...
('Qual modificador permite acesso somente dentro da classe?', 5, 1, 'b'),
('Qual conceito permite reutilização por herança?', 5, 1, 'b'),
('Qual conceito permite múltiplas formas de um método?', 5, 1, 'a'),
('Qual palavra-chave impede herança?', 5, 1, 'a'),
('Qual método é chamado ao criar um objeto?', 5, 1, 'b'),
('Qual anotação é usada para sobrescrever um método?', 5, 1, 'a'),
('Qual palavra-chave referencia a própria instância?', 5, 1, 'a'),
('Qual conceito protege os dados e expõe apenas métodos?', 5, 1, 'b');
...
('Qual artefato documenta requisitos?', 6, 1, 'c'),
('Qual diagrama UML mostra interações?', 6, 1, 'b'),
('Qual prática envolve integração frequente do código?', 6, 1, 'b'),
('Qual é o objetivo da engenharia de requisitos?', 6, 1, 'b'),
('Qual documento detalha o design do sistema?', 6, 1, 'a'),
('Qual técnica de estimativa é usada em ágil?', 6, 1, 'c'),
('Qual é um princípio do manifesto ágil?', 6, 1, 'b'),
('Qual fase do ciclo de vida inclui testes?', 6, 1, 'd');
...
('Qual memória é volátil?', 7, 1, 'd'),
('Qual barramento transfere dados?', 7, 1, 'c'),
('Qual nível de cache é mais rápido?', 7, 1, 'a'),
('Qual registrador armazena o próximo endereço de instrução?', 7, 1, 'a'),
('Qual arquitetura é usada em PCs?', 7, 1, 'c'),
('Qual componente armazena dados temporários?', 7, 1, 'a'),
('Qual unidade realiza cálculos matemáticos?', 7, 1, 'a'),
('Qual memória é somente leitura?', 7, 1, 'b');
...
('Qual protocolo é usado para transferência de arquivos?', 8, 1, 'a'),
('Qual dispositivo conecta redes diferentes?', 8, 1, 'c'),
('Qual é o endereço IP privado?', 8, 1, 'a'),
('Qual protocolo traduz nomes para IPs?', 8, 1, 'a'),
('Qual camada garante comunicação ponta a ponta?', 8, 1, 'b'),
('Qual tecnologia é usada em redes sem fio?', 8, 1, 'b'),
('Qual protocolo é usado para navegação web?', 8, 1, 'b'),
('Qual protocolo seguro substitui o HTTP?', 8, 1, 'a');
