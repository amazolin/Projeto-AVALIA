...
(8, 'A cláusula ORDER BY é usada para ordenar resultados?', 'verdadeiro_falso', 1, 1, 'a'),
(9, 'Qual comando adiciona uma nova coluna em uma tabela?', 'multipla_escolha', 1, 1, 'a'),
(10, 'A cláusula WHERE filtra registros?', 'verdadeiro_falso', 1, 1, 'a');
...
(30, 'O tipo bool armazena verdadeiro ou falso?', 'verdadeiro_falso', 3, 1, 'a');
...
(3, 'a', 'VARCHAR', FALSE), (3, 'b', 'CHAR', FALSE), (3, 'c', 'TEXT', TRUE), (3, 'd', 'INT', FALSE), (3, 'e', 'FLOAT', FALSE),
...
(8, 'a', 'Verdadeiro', TRUE), (8, 'b', 'Falso', FALSE),
(9, 'a', 'ALTER TABLE', TRUE), (9, 'b', 'CREATE COLUMN', FALSE), (9, 'c', 'ADD COLUMN', FALSE), (9, 'd', 'MODIFY', FALSE), (9, 'e', 'APPEND', FALSE),
(10, 'a', 'Verdadeiro', TRUE), (10, 'b', 'Falso', FALSE);

-- Linguagem de Programação C (id_questao 11 a 20)
INSERT INTO opcoes_questao (id_questao, letra, texto_opcao, correta) VALUES
(11, 'a', '%s', FALSE), (11, 'b', '%d', TRUE), (11, 'c', '%c', FALSE), (11, 'd', '%f', FALSE), (11, 'e', '%i', FALSE),
...
(16, 'a', 'while', TRUE), (16, 'b', 'do...while', FALSE), (16, 'c', 'for', FALSE), (16, 'd', 'foreach', FALSE), (16, 'e', 'loop', FALSE),
(17, 'a', '||', FALSE), (17, 'b', '!', FALSE), (17, 'c', '&&', TRUE), (17, 'd', '&', FALSE), (17, 'e', '==', FALSE),
(18, 'a', 'stdio.h', TRUE), (18, 'b', 'iostream', FALSE), (18, 'c', 'conio.h', FALSE), (18, 'd', 'system.h', FALSE), (18, 'e', 'string.h', FALSE),
(19, 'a', 'int', FALSE), (19, 'b', 'float', FALSE), (19, 'c', 'char', TRUE), (19, 'd', 'string', FALSE), (19, 'e', 'text', FALSE),
(20, 'a', '&', FALSE), (20, 'b', '*', TRUE), (20, 'c', '->', FALSE), (20, 'd', '=>', FALSE), (20, 'e', '%', FALSE);
...
(30, 'a', 'Verdadeiro', TRUE), (30, 'b', 'Falso', FALSE);
...
-- Garante que o próximo ID de opção gerado automaticamente será 401
